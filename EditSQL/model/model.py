...
from EditSQL.data_util.vocabulary import DEL_TOK, UNK_TOK
...
from EditSQL.data_util.atis_vocab import ATISVocabulary
...
class ATISModel(torch.nn.Module):
    ...
    def __init__(
        ...
        if 'atis' not in params.data_directory:
            if params.use_bert:
                input_vocabulary_embeddings, output_vocabulary_embeddings, output_vocabulary_schema_embeddings, \
                input_embedding_size = load_word_embeddings(input_vocabulary, output_vocabulary,
