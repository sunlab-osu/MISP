# error detector
from interaction_framework.err_detector import ErrorDetectorEvaluator, ErrorDetectorProbability, \
...
class ErrorDetectorEvaluatorSQLova(ErrorDetectorEvaluator):
    def __init__(self):
