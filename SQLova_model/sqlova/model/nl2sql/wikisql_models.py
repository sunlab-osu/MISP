...
from interaction_framework.question_gen import SELECT_COL, SELECT_AGG, WHERE_COL, WHERE_OP, WHERE_VAL, OUTSIDE
...
class Seq2SQL_v1(nn.Module):
    ...
    def interaction_beam_forward(self, wemb_n, l_n, wemb_hpu, l_hpu, l_hs, tb, nlu_t, nlu_wp_t, wp_to_wh_index, nlu,
                                 ...
                                 bool_verbal=False, dropout_rate=0.0):
        """
        @author: Ziyu Yao
                ...
                if hyp.stack.isEmpty():
                    ...
                    if vet[0] == "sc":
                        ...
                        for pair_idx, (st, ed) in enumerate(pr_wvi_beam):
                            ...
                            step_hyp.tag_seq.append((WHERE_VAL, ((table_name, wc_name, wc_idx),), wo_name, (st, ed, val_str),
                                                     prob_pair, hyp.dec_seq_idx))
