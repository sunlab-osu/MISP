...
if __name__ == '__main__':
    ...
    path_wikisql = './download/data/'
    # BERT_PT_PATH = path_wikisql
    BERT_PT_PATH = './download/bert/'

    path_save_for_evaluation = './checkpoints_0416/'
    model_path = './checkpoints_0416/'
    ...
    # path_model_bert = './checkpoints_0416/pretrained/model_bert_best.pt'
    # path_model = './checkpoints_0416/pretrained/model_best.pt'
