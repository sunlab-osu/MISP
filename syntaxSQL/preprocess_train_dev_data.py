...
def index_to_column_name_original(index, table):
    column_name = table["column_names_original"][index][1]
    table_index = table["column_names_original"][index][0]
    table_name = table["table_names_original"][table_index]
    return table_name, column_name, index
